...
Write-host "Unlinking Tier 2 RS4 policies" -ForegroundColor Green

UnlinkPolicyDevices -DisplayName "*- Tier 2 MSFT Windows 10 RS4 - Bitlocker"
UnlinkPolicyDevices -DisplayName "*- Tier 2 MSFT Windows 10 RS4 - Computer"
UnlinkPolicyDevices -DisplayName "*- Tier 2 MSFT Windows 10 and Server 2016 - Defender Antivirus - Windows 10 RS4"
UnlinkPolicyUsers -DisplayName "*- Tier 2 MSFT Windows 10 RS4 - User"
