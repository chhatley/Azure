...
Write-host "Unlinking T0 PAW RS2 policies" -ForegroundColor Green

UnlinkPolicyDevices -DisplayName "*- Tier 0 PAWs MSFT Windows 10 RS2 - Bitlocker"
UnlinkPolicyDevices -DisplayName "*- Tier 0 PAWs MSFT Windows 10 RS2 - Computer"
UnlinkPolicyDevices -DisplayName "*- Tier 0 PAWs MSFT Windows 10 and Server 2016 Defender - Windows 10 RS2"
UnlinkPolicyUsers -DisplayName "*- Tier 0 PAWs MSFT Windows 10 RS2 - User"
