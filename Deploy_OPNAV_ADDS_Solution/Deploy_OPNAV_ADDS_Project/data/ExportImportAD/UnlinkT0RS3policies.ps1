...
Write-host "Unlinking T0 PAW RS3 policies" -ForegroundColor Green

UnlinkPolicyDevices -DisplayName "*- Tier 0 PAWs MSFT Windows 10 RS3 - Bitlocker"
UnlinkPolicyDevices -DisplayName "*- Tier 0 PAWs MSFT Windows 10 RS3 - Computer"
UnlinkPolicyDevices -DisplayName "*- Tier 0 PAWs MSFT WIndows 10 and Server 2016 Defender Antivirus - Windows 10 RS3"
UnlinkPolicyUsers -DisplayName "*- Tier 0 PAWs MSFT Windows 10 RS3 - User"
