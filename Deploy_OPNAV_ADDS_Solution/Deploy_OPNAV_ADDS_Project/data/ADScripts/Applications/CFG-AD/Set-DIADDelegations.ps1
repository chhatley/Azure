...
Add-Log -LogEntry("--Beginning DIAD AD Delegations--");
...
#Get the SID values of each group (principle) we wish to delegate access to
...
Add-Log -LogEntry("--Completed DIAD AD Delegations--");
