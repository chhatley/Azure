...
Write-host "Unlinking Tier 2 RS2 policies" -ForegroundColor Green

UnlinkPolicyDevices -DisplayName "*- Tier 2 MSFT Windows 10 RS2 - Bitlocker"
UnlinkPolicyDevices -DisplayName "*- Tier 2 MSFT Windows 10 RS2 - Computer"
UnlinkPolicyDevices -DisplayName "*- Tier 2 MSFT Windows 10 and Server 2016 Defender - Windows 10 RS2"
UnlinkPolicyUsers -DisplayName "*- Tier 2 MSFT Windows 10 RS2 - User"
