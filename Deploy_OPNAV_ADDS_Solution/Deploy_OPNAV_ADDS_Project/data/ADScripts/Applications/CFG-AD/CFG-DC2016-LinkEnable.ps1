...
$sCMD1 = "$sSourceDir\SetDenyonDCGPOs.ps1"

Add-log -LogEntry ("command is $sCMD1")

Invoke-Expression $sCMD1

$sCMD1a = "$sSourceDir\LinkBuildValueWMIFiltertoDCBaseline"

Add-log -LogEntry ("command is $sCMD1a")

Invoke-Expression $sCMD1a

$sCMD2 = "$sSourceDir\LinkDCBaseline-2016.ps1"

Add-log -LogEntry ("command is $sCMD2")

Invoke-Expression $sCMD2

$sCMD3 = "$sSourceDir\LinkDomainPolices.ps1"

Add-log -LogEntry ("command is $sCMD3")

Invoke-Expression $sCMD3
